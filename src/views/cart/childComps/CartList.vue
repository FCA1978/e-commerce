<template>
  <div class="cart-list">
    <scroll class="scroll-height" ref="scroll">
      <!-- 循环部分 -->
      <div :key="index" class="shop-item" v-for="(itemInfo, index) in cartList">
       <div class="item-selector">
          <check-button :is-checked="itemInfo.checked"     @change="handleCheckedItem" v-model="itemInfo.checked" />
        </div>
        <div class="item-img">
...
export default {
  name: "CartList",
  components: { Scroll,checkButton,CartBottomBar },
  data() {
    return {
      checkedAll: false
    };
